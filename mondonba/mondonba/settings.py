"""
Django settings for mondonba project.
...
SECRET_KEY = "django-insecure-ygi2(ub2ftw%!ehcaxe$6ys(xz4e0_w0l)2ame42(-!yaz^p7v"
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'utils.context_processors.getCart'
            ],
        },
    },
]

WSGI_APPLICATION = 'mondonba.wsgi.application'
